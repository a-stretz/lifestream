// the organization Innovation Portfolio â€” Full Initiative Dataset (88 initiatives)
...
const SEED = [
  // â”€â”€ ORIGINAL 18 (backfilled with new schema fields) â”€â”€
  { id: 1, name: "AP Invoice Processing Engine", dept: "Accounting", type: "SaaS Replacement", status: "In Progress", owner: "Maria Chen", targetSaaS: "Coupa ($180k/yr)", rationalization: "Replace", capabilities: ["Workflow Automation", "Document Generation", "Integration Layer"], scores: { impact: 9, effort: 4, risk: 3, alignment: 8 }, aiLevel: "Augment", sensitivity: "Confidential", blocker: null, pattern: "HITL Routing", riskTier: "Medium", cluster: "Finance Automation", tools: ["Claude Code", "VS Code"], summary: "Vibe-coded replacement for Coupa AP module. Three-way match logic working for standard PO invoices with confidence scoring (â‰¥85 auto, 60-84 human review, <60 manual). 70% automation target by Q2. Blocked on non-PO invoice routing rules. Coupa renewal: October.",
    inputs: [
      { type: "telegram", source: "Maria Chen Â· #accounting-innovation", date: "Mar 22", text: "Just got the three-way match working for standard PO invoices. Claude handles the PO lookup, matches line items to the GRN, and flags discrepancies. Tested against 50 invoices â€” 38 clean, 9 flagged correctly for price variance, 3 mismatched on UOM (lbs vs cwt). Working on UOM mapping table. Biggest gap: non-PO invoices." },
      { type: "meeting", source: "Maria â†” Innovation Lead Weekly Sync Â· Week 12", date: "Mar 24", text: "Three-way match solid for standard POs. Building confidence score routing low-confidence to human review queue. Innovation Lead asked to document as reusable template â€” Benefits Admin and Procurement need similar HITL routing. 70% automation by Q2. Coupa renewal October." },
      { type: "process_doc", source: "Current-State AP Workflow", date: "Mar 15", text: "Invoice received â†’ scanned â†’ manual Coupa entry â†’ PO match (60% success) â†’ unmatched queued 3 days â†’ approval routing â†’ ERP export. Pain: manual bottleneck, matching unchanged since 2019, non-PO in spreadsheet. Avg 8.2 days receipt to approval." },
      { type: "builder_log", source: "Claude Code Session Â· Sprint 4", date: "Mar 26", text: "2.5 hrs, Sonnet, ~42k tokens. Built UOM conversion table. Confidence scoring 0-100. Threshold: â‰¥85 auto, 60-84 human review, <60 manual. Need to test against Feb full set (~1,200 invoices). Blocked: non-PO routing rules." }
    ]
  },
  { id: 2, name: "Financial Reporting Pipeline", dept: "Accounting", type: "SaaS Replacement", status: "In Progress", owner: "Maria Chen + Jordan Ellis", targetSaaS: "Oracle Reports ($220k/yr)", rationalization: "Replace", capabilities: ["Reporting & Analytics", "Data Pipeline", "Document Generation"], scores: { impact: 10, effort: 2, risk: 6, alignment: 9 }, aiLevel: "Augment", sensitivity: "Restricted", blocker: "Security", pattern: "Document Extraction", riskTier: "High", cluster: "Finance Automation", tools: ["Claude Code", "VS Code"], summary: "Highest-value SaaS target. Automating 14 board-level reports. CFO prioritized 3 for Q3. Intercompany eliminations complex â€” 23 categories. Parallel validation with Oracle required. Audit trail non-negotiable. October renewal leverage.",
    inputs: [
      { type: "email", source: "CFO â†’ Innovation Lead (forwarded)", date: "Mar 10", text: "Board package has 14 report types. Need 3 critical reports automated first (P&L by BU, consolidated balance sheet, cash flow forecast). If audit-ready by Q3, justifies investment and Oracle renewal leverage." },
      { type: "telegram", source: "Jordan Ellis Â· #accounting-innovation", date: "Mar 20", text: "P&L generating correctly per entity. Consolidation tricky â€” 23 intercompany elimination categories. Need version-controlled rules file finance team can update without touching code." },
      { type: "risk", source: "Innovation Lead Â· Internal Assessment", date: "Mar 22", text: "ELEVATED risk. Accuracy must be 100%. Parallel run minimum 2 months. InfoSec review required. Timeline tight for October leverage." }
    ]
  },
  { id: 3, name: "Employee Onboarding Portal", dept: "HR", type: "Net-New Tool", status: "Pilot", owner: "James Whitfield", targetSaaS: null, rationalization: null, capabilities: ["User-Facing App", "Workflow Automation"], scores: { impact: 7, effort: 6, risk: 2, alignment: 7 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Approval Workflow", riskTier: "Medium", cluster: "HR & People", tools: ["Claude", "VS Code"], summary: "Self-service onboarding replacing paper checklist. Pilot: 43 new hires, completion 4.5â†’1.8 days. Gaps: benefits enrollment, IT asset assignment, plant worker differentiation.",
    inputs: [
      ...
      { type: "telegram", source: "James Whitfield Â· #hr-innovation", date: "Mar 27", text: "43 new hires processed. 4.5â†’1.8 days. Pain points: (1) benefits manual, (2) IT disconnected, (3) plant reqs different. Guymon pilot next month." },
      { type: "meeting", source: "James â†” IT Director Biweekly Â· Week 14", date: "Apr 3", text: "Plant needs conditional logic (safety, PPE, shift). Tom Nguyen may have shared component. HRIS standalone for now, revisit after cross-environment pilot." }
    ]
  },
  { id: 4, name: "Feed Scheduling Optimizer", dept: "Feed Mills", type: "Process Automation", status: "In Progress", owner: "Carlos Reyes", targetSaaS: null, rationalization: null, capabilities: ["Scheduling & Planning", "Data Pipeline"], scores: { impact: 8, effort: 3, risk: 5, alignment: 9 }, aiLevel: "Augment", sensitivity: "Internal", blocker: "Compliance", pattern: "Scheduling", riskTier: "High", cluster: "Plant Operations", tools: ["Claude Code", "Python", "USDA API"], summary: "AI batch sequencing for 14 formulations, 3 lines. 22% changeover reduction. FDA medicated feed segregation not handled. Live Ops wants grow-out integration.",
    inputs: [
      ...
      { type: "telegram", source: "Carlos Reyes Â· #feedmill-innovation", date: "Mar 18", text: "18 months production data + USDA formulation DB. AI reduces changeover 22%. BUT medicated segregation wrong â€” FDA requires full line flush. Must hard-code constraint." },
      { type: "email", source: "Live Operations â†’ Carlos", date: "Mar 21", text: "Birds 4 days ahead at Hennessey, need finishing ration Thursday not Monday. Third emergency adjust this quarter. If AI can factor live growth data, game changer." }
    ]
  },
  { id: 5, name: "Brand Asset Generator", dept: "Marketing", type: "AI Capability", status: "Deployed", owner: "Priya Patel", targetSaaS: null, rationalization: null, capabilities: ["Document Generation"], scores: { impact: 6, effort: 8, risk: 1, alignment: 5 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Document Extraction", riskTier: "Low", cluster: "Marketing & Brand", tools: ["Claude API"], summary: "214 artifacts/month. Revision rate 41%â†’18%. Sales requesting regional pricing auto-population and current competitive data.",
    inputs: [
      { type: "output_sample", source: "Usage Log Â· March", date: "Mar 31", text: "214 artifacts: sell sheets (68), social (52), distributor (34), trade show (28), internal (22), export (10). 3.2 min avg. 18% revision rate. 4 brand compliance flags caught." },
      { type: "email", source: "Sales â†’ Priya", date: "Mar 25", text: "Core Brand Natural sell sheets are great. Need auto-populated regional pricing (6 regions) and current competitive data. Would use for every buyer meeting." }
    ]
  },
  { id: 6, name: "Security Compliance Scanner", dept: "IT / Innovation", type: "AI Capability", status: "In Progress", owner: "Innovation Lead", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Integration Layer"], scores: { impact: 9, effort: 3, risk: 2, alignment: 10 }, aiLevel: "Automate", sensitivity: "Internal", blocker: null, pattern: "Monitoring", riskTier: "Medium", cluster: "Innovation Infrastructure", tools: ["Claude Code", "Python", "GitHub API"], summary: "Agentic pipeline: RSS ingestion â†’ security scan â†’ relevance evaluation â†’ delivery. Stage 3 memory stale â€” needs initiative registry connection.",
    inputs: [
      { type: "architecture", source: "Innovation Lead Â· Pipeline v2", date: "Mar 15", text: "4-stage pipeline. Ingestion (12 RSS + 4 newsletters), Security Screen (CVE, deps, exfil, license), Relevance (agent with initiative context, â‰¥7/10 flagged), Synthesis (summary + rationale). Gap: Stage 3 stale." },
      { type: "output_sample", source: "Telegram Alert", date: "Mar 28", text: "ðŸ”’ PASS | 8.4/10 | structured-output-parser v2.1. Standardized LLM output parsing. 6 initiatives use ad-hoc parsing. MIT license, clean scan. Action: adopt as standard." }
    ]
  },
  { id: 7, name: "Production QA Visual Monitor", dept: "Processing", type: "AI Capability", status: "Discovery", owner: "Tom Nguyen", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics"], scores: { impact: 8, effort: 2, risk: 7, alignment: 8 }, aiLevel: "Experiment", sensitivity: "Internal", blocker: "Technical Feasibility", pattern: "Monitoring", riskTier: "Regulated", cluster: "Plant Operations", tools: ["TBD"], summary: "Camera-based QA supplement. 1,100 head/hr line. Discovery: hardware $64-180k, USDA regulatory path, 500 labeled images needed. 6-12 month initiative.",
    inputs: [
      { type: "discovery", source: "Tom â†” Innovation Lead Â· Office Hours", date: "Mar 18", text: "Accuracy drops last 2 hrs of shift. AI flags defects for human inspector. Supplement not replacement. 6-12 months minimum, not a vibe-coding project." },
  ...
  { id: 8, name: "Order Status Dashboard", dept: "Sales", type: "SaaS Replacement", status: "Discovery", owner: "Derek Bowman", targetSaaS: "Salesforce Reports ($95k/yr)", rationalization: "Replace", capabilities: ["Reporting & Analytics", "Data Pipeline"], scores: { impact: 7, effort: 5, risk: 4, alignment: 6 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: "Data Access", pattern: "Dashboard", riskTier: "Medium", cluster: "Commercial & Sales", tools: ["TBD"], summary: "Replace Salesforce reporting. 6 managers Ã— 45 min/Monday = 4.5 hrs/week on same report. Blocker: Salesforce + ERP data connectivity.",
    inputs: [
      { type: "telegram", source: "Derek Bowman Â· #sales-innovation", date: "Mar 14", text: "6 managers spend 45 min each Monday building same report with different filters. Auto-refreshing dashboard showing each rep's region = I'd trade Salesforce Reports tomorrow." },
      { type: "discovery", source: "Derek â†” Innovation Team", date: "Mar 19", text: "Priority: order status, complaint trends, volume vs forecast, pricing exceptions. Sources: Salesforce, ERP, Excel. Need read-only API or scheduled exports." }
    ]
  },
  { id: 9, name: "Benefits Administration Portal", dept: "HR", type: "SaaS Replacement", status: "Blocked", owner: "Lisa Park", targetSaaS: "BambooHR ($65k/yr)", rationalization: "Replace", capabilities: ["User-Facing App", "Workflow Automation", "Compliance & Audit"], scores: { impact: 6, effort: 3, risk: 6, alignment: 5 }, aiLevel: "Assist", sensitivity: "Highly Sensitive", blocker: "Security", pattern: "Approval Workflow", riskTier: "Regulated", cluster: "HR & People", tools: ["Claude", "VS Code"], summary: "BLOCKED by InfoSec. Category 1 PII via external API. Path: separate AI workflow from PII backend. Worth $65k/yr effort?",
    inputs: [
      { type: "email", source: "IT Security â†’ Lisa", date: "Mar 20", text: "Cannot approve. PII (SSN, DOB, medical) = Category 1. Browser storage not auditable. No RBAC. Path: AI handles workflow/UI, separate backend for PII." },
      { type: "telegram", source: "Lisa Park Â· #hr-innovation", date: "Mar 21", text: "Fair concerns. Real benefits data different from bootcamp synthetic data. Option (b) makes it much more complex. Worth it for $65k/yr?" }
    ]
  },
  { id: 10, name: "Dynamic Pricing Recommendations", dept: "Sales", type: "AI Capability", status: "Discovery", owner: "Derek Bowman (sponsor)", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics"], scores: { impact: 9, effort: 1, risk: 5, alignment: 7 }, aiLevel: "Experiment", sensitivity: "Restricted", blocker: "Data Access", pattern: "HITL Routing", riskTier: "High", cluster: "Commercial & Sales", tools: ["TBD"], summary: "AI pricing for commodity pork, 3 pricing models, 200+ customers. No builder assigned. Parked until Order Status Dashboard proves connectivity.",
    inputs: [
      { type: "concept", source: "Derek Bowman", date: "Mar 10", text: "Daily CME pricing Ã— 3 contract models Ã— 200+ customers. Reps spend 30-60 min per complex quote. Need informed starting point, not auto-quoting." },
      { type: "risk", source: "Innovation Lead Assessment", date: "Mar 15", text: "Complex data requirements. Pricing = competitive intelligence. No right builder. Parking until Order Status proves connectivity." }
    ]
  },
  { id: 11, name: "Route Optimization Tool", dept: "Supply Chain", type: "Process Automation", status: "Pilot", owner: "Angela Morrison", targetSaaS: null, rationalization: null, capabilities: ["Scheduling & Planning", "Data Pipeline"], scores: { impact: 8, effort: 5, risk: 4, alignment: 8 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Scheduling", riskTier: "Medium", cluster: "Logistics & Supply Chain", tools: ["Python", "OSRM"], summary: "8-week pilot: 11.8% fewer miles, ~$4,200/mo savings on 3 routes. Full fleet: $30k+/mo. Bridge issue fixed. Discussing live haul extension.",
    inputs: [
      { type: "memo", source: "Angela â†’ Supply Chain VP", date: "Mar 28", text: "3 routes, alternating weeks. 11.8% fewer miles, equal completion. ~$4,200/mo. Full fleet (22 routes): $30k+/mo. One bridge clearance fail, fixed." },
      { type: "telegram", source: "Angela Â· #supplychain-innovation", date: "Apr 1", text: "OSRM truck profile added. OSM data good for 90%, misses rural farm roads. Commercial routing $15-20k/yr, fraction of savings. Live haul team interested." }
    ]
  },
  { id: 12, name: "USDA Documentation Generator", dept: "Processing", type: "Process Automation", status: "Deployed", owner: "Tom Nguyen", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "Compliance & Audit"], scores: { impact: 7, effort: 8, risk: 2, alignment: 7 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Document Extraction", riskTier: "Medium", cluster: "Compliance & Safety", tools: ["Claude API", "Tablet UI"], summary: "1,847 docs in 8 weeks, 2 plants. Saves ~15 hrs/week. Error 0.3% vs 4.1% manual. USDA approved. China protocol needed â€” bilingual, April 15 deadline.",
    inputs: [
      { type: "output_sample", source: "Tom Â· Deployment Summary", date: "Mar 30", text: "HACCP logs, sanitation checklists, shipping certs, export health certs. 0.3% error vs 4.1% manual. USDA inspector: 'No issues.'" },
      { type: "email", source: "Export Team â†’ Tom", date: "Apr 2", text: "Need China protocol â€” ractopamine-free attestation, bilingual (English/Mandarin), AQSIQ number. First shipment April 15." }
    ]
  },
  { id: 13, name: "Ingredient Sourcing Tracker", dept: "Feed Mills", type: "Net-New Tool", status: "In Progress", owner: "Carlos Reyes", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics"], scores: { impact: 6, effort: 6, risk: 3, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Dashboard", riskTier: "Low", cluster: "Plant Operations", tools: ["Claude", "CSV tools"], summary: "Consolidates 4 data sources. V1: inventory, days of supply, pricing, <5-day alerts. Caught lysine shortage 4 days early. Next: automated refresh.",
    inputs: [
      { type: "telegram", source: "Carlos Â· #feedmill-innovation", date: "Mar 12", text: "Data in 4 places. Over-ordered soybean meal because procurement and ERP didn't sync. $8k unnecessary freight." },
      { type: "builder_log", source: "Carlos â†’ Innovation Lead", date: "Mar 16", text: "V1 built over weekend. CSV-fed dashboard. Caught lysine shortage 4 days early. Next: automate refresh." }
    ]
  },
  { id: 14, name: "Social Content Pipeline", dept: "Marketing", type: "SaaS Replacement", status: "In Progress", owner: "Priya Patel", targetSaaS: "Sprout Social ($40k/yr)", rationalization: "Reduce", capabilities: ["Document Generation", "Workflow Automation"], scores: { impact: 5, effort: 7, risk: 2, alignment: 4 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Document Extraction", riskTier: "Low", cluster: "Marketing & Brand", tools: ["Claude API"], summary: "Platform-specific social formatting. Strategic: Sprout value is scheduling, not content. Keep scheduling, retire content seats, save ~$25k. 'Replace vs reduce vs retain' case study.",
    inputs: [
      { type: "telegram", source: "Priya Â· #marketing-innovation", date: "Mar 22", text: "Extended for Instagram, Facebook, LinkedIn, X with platform-specific copy. Question: build scheduling too or overreach?" },
      { type: "telegram", source: "Innovation Lead Â· Response", date: "Mar 22", text: "Keep Sprout for scheduling/analytics, kill content creation seats. $25k not $40k. Good case study for 'replace vs reduce vs retain.'" }
    ]
  },
  { id: 15, name: "Internal Knowledge Base", dept: "IT / Innovation", type: "AI Capability", status: "Discovery", owner: "IT Director", targetSaaS: null, rationalization: null, capabilities: ["User-Facing App", "Data Pipeline", "Document Generation"], scores: { impact: 7, effort: 3, risk: 3, alignment: 7 }, aiLevel: "Assist", sensitivity: "Internal", blocker: "Ownership", pattern: "Search/Retrieval", riskTier: "Low", cluster: "Innovation Infrastructure", tools: ["TBD"], summary: "Searchable index of ~50 skill.md files, templates, decisions. Builders duplicate existing work. Innovation Lead: require artifact registration. Connects to scanner stale-memory problem.",
    inputs: [
      { type: "concept", source: "IT Director Â· Innovation Leads", date: "Mar 25", text: "~50 skill files, hundreds of templates, tribal knowledge. New cohort: 2 hrs finding resources. Need searchable knowledge base." },
      { type: "feedback", source: "Anonymous Â· Cohort 3", date: "Apr 1", text: "Spent two days building output parser Maria already built better. Need search." },
      { type: "telegram", source: "Innovation Lead Response", date: "Mar 26", text: "Require artifact registration. Scanner agent needs initiative context â€” registry solves stale memory AND feeds knowledge base." }
    ]
  },
  { id: 16, name: "Maintenance Scheduling System", dept: "Operations", type: "SaaS Replacement", status: "Discovery", owner: "Unassigned", targetSaaS: "UpKeep CMMS ($75k/yr)", rationalization: "Replace", capabilities: ["Scheduling & Planning", "Workflow Automation"], scores: { impact: 7, effort: 3, risk: 5, alignment: 6 }, aiLevel: "Experiment", sensitivity: "Internal", blocker: "Ownership", pattern: "Scheduling", riskTier: "Medium", cluster: "Plant Operations", tools: ["TBD"], summary: "Replace UpKeep â€” $75k/yr, using 30% of features. Team not technical. Discovery not started â€” needs PM assignment.",
    inputs: [
      { type: "email", source: "Operations VP â†’ IT Director", date: "Mar 28", text: "$75k/yr for work orders and PM schedules. 30% feature utilization. Need dead simple replacement." },
  ...
  { id: 17, name: "Regulatory Update Monitor", dept: "Compliance", type: "AI Capability", status: "In Progress", owner: "Innovation Lead", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Compliance & Audit", "Integration Layer"], scores: { impact: 8, effort: 5, risk: 2, alignment: 9 }, aiLevel: "Automate", sensitivity: "Internal", blocker: null, pattern: "Monitoring", riskTier: "Medium", cluster: "Compliance & Safety", tools: ["Claude Code", "Python", "RSS feeds"], summary: "Extension of Security Scanner for regulatory monitoring. Gap: can't map to specific facilities or initiatives. Needs registry for context.",
    inputs: [
      { type: "architecture", source: "Innovation Lead Â· Extension Notes", date: "Mar 20", text: "Same pipeline, different sources: USDA FSIS, FDA, EPA, OSHA, state regs (KS/OK/CO). Agent can't map to specific facilities." },
      { type: "output_sample", source: "Regulatory Alert", date: "Mar 28", text: "ðŸ“‹ 9.1/10 | USDA FSIS 6100.4 Rev 3. STEC sampling 1xâ†’2x/week. Impacts Guymon + St. Joseph. USDA Doc Generator needs template update." }
    ]
  },
  { id: 18, name: "AID Bootcamp Progress Tracker", dept: "HR", type: "Net-New Tool", status: "In Progress", owner: "James Whitfield + IT Director", targetSaaS: null, rationalization: null, capabilities: ["User-Facing App", "Reporting & Analytics"], scores: { impact: 5, effort: 7, risk: 1, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Dashboard", riskTier: "Low", cluster: "Innovation Infrastructure", tools: ["Claude", "VS Code"], summary: "94 enrolled, 77% graduates active. Gap: no post-graduation skill tracking or builder-project matching. Plant underrepresented.",
    inputs: [
      { type: "output_sample", source: "IT Director Â· Leads Meeting", date: "Mar 27", text: "Cohorts 1-3: 94 enrolled, 12 depts. C1 88%, C2 79%, C3 in progress. Post-bootcamp: 77% contributed. Plant lowest." },
      { type: "telegram", source: "Innovation Lead Â· Feature Request", date: "Mar 28", text: "Which graduates are ready for complex initiatives? Skills matrix from actual work, not self-reported." },
      { type: "feedback", source: "Anonymous Â· Cohort 2", date: "Mar 20", text: "Built meeting notes summarizer. Works. But don't know what to do next. Want 'open projects matching your skills' dashboard." }
    ]
  },

  // â”€â”€ EXPANSION INITIATIVES 19-88 â”€â”€
  ...
  { id: 19, name: "Expense Report Auto-Audit", dept: "Accounting", type: "Process Automation", status: "Discovery", owner: "Jordan Ellis", targetSaaS: "Concur ($partial)", rationalization: "Reduce", capabilities: ["Compliance & Audit", "Workflow Automation", "Reporting & Analytics"], scores: { impact: 6, effort: 6, risk: 3, alignment: 6 }, aiLevel: "Augment", sensitivity: "Confidential", blocker: null, pattern: "Exception Triage", riskTier: "Medium", cluster: "Finance Automation", tools: ["Claude Code", "VS Code"], summary: "Pre-audit layer for expense reports. Rules engine for meal limits, hotel caps, duplicate receipts. 120 test reports: 84 clean, 29 review, 7 false positives from split receipts. Needs structured policy table.",
    inputs: [
      { type: "email", source: "Controller â†’ Jordan", date: "Apr 1", text: "Expense review is weekly bottleneck. Managers inconsistent â€” one flags upgrades, another ignores. Need pre-audit routing exceptions to managers." },
  ...
  { id: 20, name: "Vendor Contract Clause Extractor", dept: "Legal / Procurement", type: "AI Capability", status: "In Progress", owner: "Rachel Kim", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "Compliance & Audit", "Data Pipeline"], scores: { impact: 7, effort: 5, risk: 5, alignment: 7 }, aiLevel: "Augment", sensitivity: "Confidential", blocker: null, pattern: "Document Extraction", riskTier: "High", cluster: "Finance Automation", tools: ["Claude Code", "VS Code"], summary: "Extracts renewal dates, termination notice, auto-renewal, price escalation, liability caps from vendor contracts. Struggles with amendments and scanned PDFs. Legal needs source page + confidence per field.",
    inputs: [
      { type: "telegram", source: "Rachel Kim Â· #procurement-innovation", date: "Apr 3", text: "Clause extractor working on simple agreements. Pulls renewal, termination, auto-renewal, pricing, liability, data processing, audit rights. Struggles with amendments and exhibits. Need source page + excerpt for Legal trust." },
      { type: "meeting", source: "Legal Review Notes", date: "Apr 4", text: "Extractor useful as triage, not decision-maker. Every clause needs page + confidence. Priority: renewal risk â€” auto-renewing contracts within 120 days needing 60-day notice. Mark 'not found' clearly." }
    ]
  },
  { id: 21, name: "Cash Flow Variance Explainer", dept: "Finance", type: "Reporting & Analytics", status: "Pilot", owner: "Jordan Ellis", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Document Generation", "Data Pipeline"], scores: { impact: 7, effort: 6, risk: 4, alignment: 7 }, aiLevel: "Augment", sensitivity: "Restricted", blocker: null, pattern: "Document Extraction", riskTier: "High", cluster: "Finance Automation", tools: ["Claude Code", "VS Code"], summary: "Generates first-draft cash flow commentary. Groups variances into operating, working capital, financing, timing. Over-explains small variances â€” needs materiality threshold.",
    inputs: [
      { type: "email", source: "CFO â†’ Finance", date: "Apr 1", text: "Commentary takes too long and reads like copied numbers. Need draft explaining what changed and why. Jordan edits before monthly package." },
  ...
  { id: 22, name: "Intercompany Reconciliation Assistant", dept: "Accounting", type: "Process Automation", status: "Discovery", owner: "Maria Chen + Jordan Ellis", targetSaaS: "Oracle ($partial)", rationalization: "Reduce", capabilities: ["Data Pipeline", "Workflow Automation", "Compliance & Audit"], scores: { impact: 8, effort: 3, risk: 6, alignment: 8 }, aiLevel: "Augment", sensitivity: "Restricted", blocker: "Data Access", pattern: "HITL Routing", riskTier: "High", cluster: "Finance Automation", tools: ["Claude Code"], summary: "Matcher for intercompany transactions. 71% match rate, misses from timing differences. Needs confidence score and human review queue like AP Engine.",
    inputs: [
      ...
      { type: "telegram", source: "Maria Â· #accounting-innovation", date: "Apr 3", text: "71% match rate on synthetic data. Misses mostly timing (Mar 31 vs Apr 1). +/- 5 day window improved but created false matches on recurring freight. Needs confidence score + HITL queue." }
    ]
  },
  { id: 23, name: "Budget Forecast Adjustment Tool", dept: "Finance", type: "AI Capability", status: "Discovery", owner: "CFO sponsoring", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline", "Document Generation"], scores: { impact: 8, effort: 2, risk: 5, alignment: 8 }, aiLevel: "Experiment", sensitivity: "Restricted", blocker: "Data Access", pattern: "HITL Routing", riskTier: "High", cluster: "Finance Automation", tools: ["TBD"], summary: "AI-suggested forecast adjustments from operating signals. High-value but premature â€” needs Financial Reporting and Ingredient Sourcing to mature first.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 3", text: "High-value but premature. Requires trusted data feeds. Sequence after Financial Reporting and Ingredient Sourcing. Frame as 'forecast support' not 'automated forecasting.'" }
    ]
  },
  { id: 24, name: "Recurring Payment Monitor", dept: "Accounting / Procurement", type: "Process Automation", status: "In Progress", owner: "Rachel Kim", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Compliance & Audit", "Data Pipeline"], scores: { impact: 6, effort: 7, risk: 2, alignment: 8 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Exception Triage", riskTier: "Low", cluster: "Finance Automation", tools: ["Claude", "CSV tools"], summary: "Found 17 untracked recurring charges. Creates review queue with evidence. Feeds SaaS rationalization. Fast win â€” one canceled duplicate justifies prototype.",
    inputs: [
      { type: "telegram", source: "Rachel Â· #procurement-innovation", date: "Apr 5", text: "Found 17 recurring charges not in SaaS tracker. $499/mo, $1,200/quarter, $8k annual. Several have unknown ownership. Feeds directly into rationalization." },
      { type: "meeting", source: "Rachel â†” IT Director", date: "Apr 6", text: "Separate: legitimate recurring, duplicate subs, unknown ownership. First version: review queue with invoice history, frequency, department, last requester. Don't auto-recommend cancellation." }
    ]
  },
  ...
  { id: 26, name: "Fixed Asset Depreciation Tracker", dept: "Accounting", type: "Process Automation", status: "Discovery", owner: "Maria Chen", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics", "Compliance & Audit"], scores: { impact: 5, effort: 6, risk: 3, alignment: 5 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "HITL Routing", riskTier: "Low", cluster: "Finance Automation", tools: ["Claude", "VS Code"], summary: "Suggests asset category, useful life, depreciation start from purchase descriptions. Struggles with bundled projects â€” needs split-allocation workflow.",
    inputs: [
      ...
      { type: "builder_log", source: "Maria Builder Note", date: "Apr 5", text: "Prototype reads purchase files, suggests category/life/start date. Works for obvious equipment. Struggles with bundled projects â€” needs split-allocation." }
    ]
  },
  { id: 27, name: "Invoice Fraud Detection Layer", dept: "Accounting / IT Security", type: "AI Capability", status: "Discovery", owner: "Innovation Lead + Maria Chen", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Data Pipeline", "Reporting & Analytics"], scores: { impact: 8, effort: 4, risk: 4, alignment: 8 }, aiLevel: "Augment", sensitivity: "Restricted", blocker: "Security", pattern: "Exception Triage", riskTier: "High", cluster: "Finance Automation", tools: ["Claude Code"], summary: "Separate fraud risk score from AP matching confidence. Flags: new bank account, urgent language, threshold-adjacent amounts, domain mismatch, remittance changes. Needs InfoSec review.",
    inputs: [
      ...
      { type: "telegram", source: "Maria Â· #accounting-innovation", date: "Apr 4", text: "Added fraud flags as separate score from matching confidence. High-confidence match can still be high-risk payment if bank details changed. Need InfoSec input." }
    ]
  },
  { id: 28, name: "Month-End Close Checklist Engine", dept: "Accounting", type: "Net-New Tool", status: "Pilot", owner: "Jordan Ellis", targetSaaS: null, rationalization: null, capabilities: ["Workflow Automation", "Reporting & Analytics", "User-Facing App"], scores: { impact: 6, effort: 8, risk: 2, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Approval Workflow", riskTier: "Low", cluster: "Finance Automation", tools: ["Claude", "VS Code"], summary: "43 close tasks with owners, dependencies, due dates, blockers. Dependency visibility shows downstream impacts. Generates daily close summary for Controller.",
    inputs: [
      { type: "telegram", source: "Jordan Â· #accounting-innovation", date: "Apr 6", text: "Close checklist v1 live. 43 tasks with dependencies. When AP accruals late, shows which downstream reports affected. Generates daily close summary." },
      { type: "feedback", source: "Controller", date: "Apr 7", text: "Better than spreadsheet â€” see blockers in one place. Add templates by close day (Day -1 through Day 3) and 'at risk' flag for 4+ hour dependency delays." }
    ]
  },
  { id: 29, name: "Shift Scheduling Optimizer", dept: "HR / Processing", type: "Process Automation", status: "Discovery", owner: "James Whitfield", targetSaaS: "Kronos ($partial)", rationalization: "Augment", capabilities: ["Scheduling & Planning", "Data Pipeline", "Workflow Automation"], scores: { impact: 8, effort: 3, risk: 6, alignment: 8 }, aiLevel: "Augment", sensitivity: "Confidential", blocker: "Compliance", pattern: "Scheduling", riskTier: "High", cluster: "Plant Operations", tools: ["TBD"], summary: "Optimize shift assignments for 2,000+ plant workers. Must handle certifications, labor law, seniority, union rules. Kronos stays as system of record â€” this augments, not replaces.",
    inputs: [
  ...
  { id: 35, name: "Employee Sentiment Analyzer", dept: "HR", type: "Reporting & Analytics", status: "Discovery", owner: "HR Business Partner team", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Document Generation"], scores: { impact: 5, effort: 5, risk: 6, alignment: 5 }, aiLevel: "Assist", sensitivity: "Highly Sensitive", blocker: "Compliance", pattern: null, riskTier: "Regulated", cluster: "HR & People", tools: ["TBD"], summary: "Themes from surveys and exit interviews by facility, role, tenure. Must aggregate and anonymize. No Telegram/chat ingestion without policy approval.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 5", text: "Useful but sensitive. Aggregate only. No connecting named comments to individuals. Process anonymized survey exports. Good example where governance defines the boundary." }
    ]
  },
  { id: 36, name: "PTO Approval Workflow", dept: "HR / Operations", type: "Process Automation", status: "Discovery", owner: "Plant HR Lead", targetSaaS: "Kronos ($partial)", rationalization: "Augment", capabilities: ["Workflow Automation", "Scheduling & Planning", "User-Facing App"], scores: { impact: 6, effort: 4, risk: 5, alignment: 5 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "HITL Routing", riskTier: "Medium", cluster: "HR & People", tools: ["TBD"], summary: "Coverage risk indicator for PTO approvals. Supervisors still decide â€” tool shows impact of approval on staffing/certifications.",
    inputs: [
  ...
  { id: 39, name: "Shipment Delay Prediction Engine", dept: "Supply Chain", type: "AI Capability", status: "In Progress", owner: "Angela Morrison", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics", "Scheduling & Planning"], scores: { impact: 8, effort: 5, risk: 4, alignment: 8 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Monitoring", riskTier: "Medium", cluster: "Logistics & Supply Chain", tools: ["Python", "Claude Code"], summary: "Flagged 12 high-risk shipments, 8 actually late. Misses from plant loading delays not captured. Sales wants 6-hour early warning.",
    inputs: [
      { type: "telegram", source: "Angela Â· #supplychain-innovation", date: "Apr 7", text: "Delay model v1 useful. Inputs: carrier history, route, weather, loading delays, appointment windows. 12 flagged, 8 late. Misses from dock data gaps." },
  ...
  { id: 40, name: "Cold Chain Temperature Monitor", dept: "Supply Chain / QA", type: "AI Capability", status: "Discovery", owner: "QA Logistics Lead", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Compliance & Audit", "Reporting & Analytics"], scores: { impact: 8, effort: 3, risk: 7, alignment: 8 }, aiLevel: "Assist", sensitivity: "Internal", blocker: "Compliance", pattern: "Exception Triage", riskTier: "Regulated", cluster: "Compliance & Safety", tools: ["TBD"], summary: "Classify temperature excursions by severity. QA makes disposition decisions. First MVP: historical analysis, not real-time. Food safety thresholds from QA, not model.",
    inputs: [
      { type: "process_doc", source: "QA Logistics Note", date: "Apr 5", text: "Temperature data available but exception review inconsistent. Loading spike â‰  sustained transit issue. Need severity classification. Current: someone opens PDFs after delivery." },
  ...
  { id: 41, name: "Dock Scheduling Optimizer", dept: "Supply Chain / Processing", type: "Process Automation", status: "Pilot", owner: "Angela Morrison", targetSaaS: null, rationalization: null, capabilities: ["Scheduling & Planning", "Workflow Automation", "Reporting & Analytics"], scores: { impact: 7, effort: 6, risk: 3, alignment: 7 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Scheduling", riskTier: "Medium", cluster: "Logistics & Supply Chain", tools: ["Python", "Claude Code"], summary: "Guymon dock pilot: carrier wait 71â†’46 min. Failure mode: late production updates. Override button requested by supervisors.",
    inputs: [
      { type: "memo", source: "Pilot Memo", date: "Apr 8", text: "2-week Guymon outbound. Wait time 71â†’46 min. Sequences by product availability, trailer type, bay constraints, customer priority. Failure: late production updates." },
  ...
  { id: 42, name: "Carrier Performance Scoring", dept: "Supply Chain / Procurement", type: "Reporting & Analytics", status: "Discovery", owner: "Angela Morrison", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline"], scores: { impact: 6, effort: 6, risk: 3, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: "Data Access", pattern: "Dashboard", riskTier: "Low", cluster: "Logistics & Supply Chain", tools: ["Python", "CSV tools"], summary: "Consistent carrier scorecard: on-time, claims, temperature, tender acceptance, cost. Needed before next carrier negotiation cycle.",
    inputs: [
      ...
      { type: "telegram", source: "Angela Â· #supplychain", date: "Apr 7", text: "Started with shipment data merge from 3 sources. Can build scorecard by carrier and lane. Some carriers look great on cost but terrible on claims." }
    ]
  },
  { id: 43, name: "Inventory Rebalancing Recommender", dept: "Sales / Supply Chain", type: "AI Capability", status: "Discovery", owner: "Derek Bowman + Angela Morrison", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline", "Scheduling & Planning"], scores: { impact: 7, effort: 3, risk: 4, alignment: 7 }, aiLevel: "Experiment", sensitivity: "Confidential", blocker: "Data Access", pattern: "HITL Routing", riskTier: "Medium", cluster: "Logistics & Supply Chain", tools: ["TBD"], summary: "Identify regional inventory imbalances and recommend transfer/discount/redirect. Depends on Order Status and Route Optimization data connectivity.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 7", text: "Good candidate after Order Status + Route Optimization prove data patterns. Risk: recommendations that look good on inventory but bad on margin. First MVP: identify imbalances, show tradeoffs." }
    ]
  },
  { id: 44, name: "Freight Cost Anomaly Detector", dept: "Supply Chain / Accounting", type: "Process Automation", status: "In Progress", owner: "Angela Morrison + AP team", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Compliance & Audit", "Reporting & Analytics"], scores: { impact: 7, effort: 6, risk: 3, alignment: 7 }, aiLevel: "Augment", sensitivity: "Confidential", blocker: null, pattern: "Exception Triage", riskTier: "Medium", cluster: "Logistics & Supply Chain", tools: ["Claude Code", "Python"], summary: "Matches freight invoices to shipment records and contracts. Found 14/220 questionable charges, mostly detention without supporting timestamps. Needs clause extractor from Initiative 20.",
    inputs: [
      { type: "email", source: "AP â†’ Angela", date: "Apr 5", text: "Freight invoices with accessorials (detention, layover, fuel surcharge) â€” AP can't validate without shipment events and contract terms." },
      { type: "builder_log", source: "Freight Anomaly v1", date: "Apr 8", text: "Matched invoices to shipments and contracts. 14/220 questionable. Mostly detention where timestamps don't support billed hours. Blocked: contract terms are PDFs â€” need clause extractor." }
    ]
  },
  { id: 45, name: "Live Haul Coordination Dashboard", dept: "Live Operations", type: "Net-New Tool", status: "Discovery", owner: "Live Ops Transportation Lead", targetSaaS: null, rationalization: null, capabilities: ["Scheduling & Planning", "Data Pipeline", "Reporting & Analytics"], scores: { impact: 9, effort: 2, risk: 7, alignment: 9 }, aiLevel: "Experiment", sensitivity: "Internal", blocker: "Technical Feasibility", pattern: "Dashboard", riskTier: "High", cluster: "Plant Operations", tools: ["TBD"], summary: "Complex scheduling: farm locations, animal welfare transit limits, weather, plant capacity, biosecurity. Start with visibility dashboard, not optimization.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 8", text: "Not a bootcamp project. First step: visibility dashboard â€” planned pickups, plant windows, route status, constraint violations. Don't start with optimization." }
    ]
  },
  { id: 46, name: "Backhaul Opportunity Finder", dept: "Supply Chain", type: "Reporting & Analytics", status: "Discovery", owner: "Angela Morrison", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Scheduling & Planning", "Reporting & Analytics"], scores: { impact: 6, effort: 5, risk: 3, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Search/Retrieval", riskTier: "Low", cluster: "Logistics & Supply Chain", tools: ["Python"], summary: "Surface nearby pickup opportunities after delivery. Uses route data from optimization pilot. Show matches, don't auto-book.",
    inputs: [
      ...
      { type: "telegram", source: "Angela Â· #supplychain", date: "Apr 8", text: "Already have route data from pilot. Add delivery time and trailer availability to surface possible backhauls. Internal transfers first or external load boards?" }
    ]
  },
  { id: 47, name: "Packaging Material Forecasting", dept: "Procurement / Processing", type: "AI Capability", status: "In Progress", owner: "Procurement Packaging Buyer", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics", "Scheduling & Planning"], scores: { impact: 6, effort: 6, risk: 3, alignment: 6 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Monitoring", riskTier: "Low", cluster: "Plant Operations", tools: ["Claude", "CSV tools"], summary: "Forecasts packaging demand from production schedule. Caught bilingual export label shortage. Substitution logic needs approval workflow.",
    inputs: [
      ...
      { type: "feedback", source: "Processing Supervisor", date: "Apr 8", text: "Substitutions complicated â€” Sales promised branded cases, QA requires specific labels for export. Need 'substitution allowed' field and approval." }
    ]
  },
  { id: 48, name: "Export Documentation Tracker", dept: "Export / Compliance", type: "Process Automation", status: "Pilot", owner: "Export Documentation Lead", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Workflow Automation", "Document Generation"], scores: { impact: 8, effort: 6, risk: 5, alignment: 8 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Approval Workflow", riskTier: "High", cluster: "Compliance & Safety", tools: ["Claude", "VS Code"], summary: "Country-specific document checklists for Japan, Korea, Mexico, China. Flags outdated certificate templates. Export Compliance retains final review.",
    inputs: [
      { type: "output_sample", source: "Export Team Update", date: "Apr 8", text: "V1 covers 4 markets. Shows required docs, owner, due date, status, missing fields. Flags outdated templates â€” people were using old language requirements." },
  ...
  { id: 50, name: "Yield Optimization Assistant", dept: "Processing / Finance", type: "AI Capability", status: "Discovery", owner: "Plant Controller", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics"], scores: { impact: 9, effort: 2, risk: 6, alignment: 9 }, aiLevel: "Experiment", sensitivity: "Confidential", blocker: "Data Access", pattern: "Dashboard", riskTier: "High", cluster: "Plant Operations", tools: ["TBD"], summary: "Small yield changes = large financial impact. First phase: data readiness and dashboarding. Staged roadmap: visibility â†’ explanation â†’ recommendation.",
    inputs: [
      { type: "concept", source: "Plant Controller", date: "Apr 7", text: "Track input/output weight, trim, rework, waste, line speed. Analysis is retrospective â€” shift already over. Need real-time visibility into where yield loss occurs." },
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 8", text: "High upside but data quality is the blocker. Noisy source data = false explanations. First: data readiness + dashboarding, not optimization." }
    ]
  },
  ...
  { id: 52, name: "Sanitation Compliance Tracker", dept: "Processing / QA", type: "Compliance & Audit", status: "In Progress", owner: "Tom Nguyen + Sanitation Lead", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Workflow Automation", "User-Facing App"], scores: { impact: 8, effort: 7, risk: 5, alignment: 8 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Approval Workflow", riskTier: "Regulated", cluster: "Compliance & Safety", tools: ["Claude", "Tablet UI"], summary: "Tablet-based pre-op checklist. Timestamps zones, supervisor sign-off, flags missed items before line starts. Needs immutable edit history for USDA.",
    inputs: [
      { type: "telegram", source: "Tom Â· #processing-innovation", date: "Apr 8", text: "Tablet pre-op checklist. Timestamps zones, supervisor sign-off, flags missed items. No more illegible paper forms." },
  ...
  { id: 53, name: "Equipment Failure Predictor", dept: "Maintenance / Operations", type: "AI Capability", status: "Discovery", owner: "Maintenance Manager", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics", "Scheduling & Planning"], scores: { impact: 8, effort: 2, risk: 5, alignment: 8 }, aiLevel: "Experiment", sensitivity: "Internal", blocker: "Data Access", pattern: "Monitoring", riskTier: "Medium", cluster: "Plant Operations", tools: ["TBD"], summary: "Years of work order history but not clean. Start with data cleanup + asset hierarchy normalization. Prediction later. First MVP: repeat-failure assets and PM compliance gaps.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 8", text: "Start with data cleanup and asset normalization. Prediction depends on good asset IDs, failure codes, timestamps. First MVP: repeat-failure assets and PM gaps." }
    ]
  },
  { id: 54, name: "Worker Safety Risk Detection", dept: "Safety / Processing", type: "AI Capability", status: "Discovery", owner: "Safety Director", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Compliance & Audit", "Data Pipeline"], scores: { impact: 8, effort: 1, risk: 8, alignment: 8 }, aiLevel: "Experiment", sensitivity: "Highly Sensitive", blocker: "Compliance", pattern: null, riskTier: "Regulated", cluster: "Compliance & Safety", tools: ["TBD"], summary: "Camera-based unsafe condition detection. HIGH RISK â€” privacy, trust, labor/legal review required. Safer first: de-identified observation analysis. Camera AI later phase only.",
    inputs: [
  ...
  { id: 55, name: "Production Throughput Dashboard", dept: "Processing / Operations", type: "Reporting & Analytics", status: "Pilot", owner: "Plant Operations Manager", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline", "User-Facing App"], scores: { impact: 7, effort: 6, risk: 3, alignment: 7 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Dashboard", riskTier: "Low", cluster: "Plant Operations", tools: ["Claude", "CSV tools"], summary: "Planned vs actual throughput by line, shift, product, downtime category. Updates from CSV exports every 30 min. Phone view needs simplification â€” 5 items only.",
    inputs: [
      ...
      { type: "feedback", source: "Supervisor", date: "Apr 9", text: "Useful on big screen, not on phone â€” too dense. Shift view needs only: target, actual, variance, top blocker, next action. Plant tools need simpler screens." }
    ]
  },
  ...
  { id: 57, name: "Shift Handoff Summary Generator", dept: "Processing / Operations", type: "Process Automation", status: "In Progress", owner: "Plant Supervisor", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "Workflow Automation"], scores: { impact: 6, effort: 8, risk: 2, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Document Extraction", riskTier: "Low", cluster: "Plant Operations", tools: ["Claude", "Tablet UI"], summary: "Outgoing supervisor enters status, issues, gaps, equipment, QA holds, safety notes â†’ clean handoff for next shift. Need required fields and 'decisions made during shift' section.",
    inputs: [
      ...
      { type: "feedback", source: "Night Shift", date: "Apr 9", text: "Need consistency â€” some supervisors write too much, some too little. Required fields + 'no update' checkboxes + 'decisions made during shift' section." }
    ]
  },
  { id: 58, name: "Quality Deviation Tracker", dept: "QA / Processing", type: "Compliance & Audit", status: "Pilot", owner: "Tom Nguyen", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Reporting & Analytics", "Workflow Automation"], scores: { impact: 8, effort: 6, risk: 5, alignment: 8 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Exception Triage", riskTier: "Medium", cluster: "Compliance & Safety", tools: ["Claude", "VS Code"], summary: "Captures deviation type, product, lot, severity, disposition, corrective action. Trend detection surfaced repeated labeling deviations. Needs escalation rules and linked documentation.",
    inputs: [
      ...
      { type: "feedback", source: "QA Manager", date: "Apr 10", text: "Add escalation: same type 3x in 14 days â†’ notify QA manager + Ops. Hold/rework requires linked docs. No closure without corrective action owner." }
    ]
  },
  { id: 59, name: "Customer Order Pattern Analyzer", dept: "Sales", type: "Reporting & Analytics", status: "Discovery", owner: "Derek Bowman", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline"], scores: { impact: 7, effort: 5, risk: 3, alignment: 6 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: "Data Access", pattern: "Monitoring", riskTier: "Medium", cluster: "Commercial & Sales", tools: ["TBD"], summary: "Alert for order frequency changes, product mix shifts, cancellations. Should plug into Order Status Dashboard, not be separate. Surface obvious pattern changes earlier.",
    inputs: [
      ...
      { type: "telegram", source: "Derek Â· #sales-innovation", date: "Apr 8", text: "Plug into Order Status Dashboard, not separate app. Rep opens region view, sees 'customers with unusual pattern changes' ranked by revenue impact. Keep it simple." }
    ]
  },
  { id: 60, name: "Sales Call Summary Generator", dept: "Sales", type: "Process Automation", status: "Pilot", owner: "Sales Enablement Lead", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "Workflow Automation", "User-Facing App"], scores: { impact: 5, effort: 8, risk: 2, alignment: 5 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Document Extraction", riskTier: "Low", cluster: "Commercial & Sales", tools: ["Claude"], summary: "Rough call notes â†’ structured summary: customer asks, pricing, volume risk, follow-ups, next meeting. Saves 10 min/call. Needs standard tags and confidential pricing controls.",
    inputs: [
  ...
  { id: 61, name: "Promotion Effectiveness Tracker", dept: "Sales / Marketing", type: "Reporting & Analytics", status: "Discovery", owner: "Priya Patel + Derek Bowman", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline", "Document Generation"], scores: { impact: 6, effort: 4, risk: 3, alignment: 5 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: "Data Access", pattern: "Dashboard", riskTier: "Low", cluster: "Commercial & Sales", tools: ["TBD"], summary: "Post-promotion readout: lift, margin, sell-through, repeat, demand pull-forward. Question isn't 'did volume go up?' â€” it's 'did we make money and should we repeat?'",
    inputs: [
  ...
  { id: 62, name: "Customer Risk Scoring Model", dept: "Sales / Finance", type: "AI Capability", status: "Discovery", owner: "Derek Bowman", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline"], scores: { impact: 7, effort: 3, risk: 5, alignment: 6 }, aiLevel: "Experiment", sensitivity: "Confidential", blocker: "Data Access", pattern: "Monitoring", riskTier: "Medium", cluster: "Commercial & Sales", tools: ["TBD"], summary: "Early warning on at-risk accounts. Needs reason codes and evidence, not black-box scoring. Some customers remain active but become unprofitable.",
    inputs: [
      { type: "concept", source: "Sales Leadership", date: "Apr 8", text: "Signals: order decline, complaints, late payments, pricing disputes, competitor activity. Not just churn â€” some become unprofitable while active." },
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 9", text: "Needs reason codes and evidence. 'Volume down 18% vs baseline, complaints increased, payment terms exceeded twice.' Avoid black-box scoring." }
    ]
  },
  ...
  { id: 65, name: "Reusable Workflow Template Library", dept: "IT / Innovation", type: "Net-New Tool", status: "Discovery", owner: "IT Director + Innovation Lead", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "User-Facing App", "Workflow Automation"], scores: { impact: 8, effort: 6, risk: 2, alignment: 10 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Search/Retrieval", riskTier: "Low", cluster: "Innovation Infrastructure", tools: ["Claude Code", "VS Code"], summary: "Standardize repeating patterns: confidence scoring, output parsing, approval routing, exception dashboards, audit logs. New builders start from proven templates instead of reinventing.",
    inputs: [
      { type: "concept", source: "IT Director Concept Note", date: "Apr 7", text: "Keep rebuilding same patterns: confidence score â†’ human review, output parsing, approval routing, exception dashboards, audit logs. Should become templates." },
  ...
  { id: 66, name: "Data Access Request Router", dept: "IT / Security", type: "Process Automation", status: "Discovery", owner: "IT Security Analyst", targetSaaS: null, rationalization: null, capabilities: ["Workflow Automation", "Compliance & Audit", "Integration Layer"], scores: { impact: 8, effort: 5, risk: 4, alignment: 9 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Approval Workflow", riskTier: "Medium", cluster: "Innovation Infrastructure", tools: ["TBD"], summary: "Standardized data access request flow. Captures purpose, classification, fields, retention, API exposure. Highest-leverage internal tool â€” data access blocks 4+ initiatives.",
    inputs: [
      ...
      { type: "telegram", source: "Innovation Lead Response", date: "Apr 9", text: "Probably highest-leverage internal tool. Data access blocks Order Status, Pricing, Finance, Ingredient Sourcing, more. Standard intake speeds safe projects, stops unsafe ones earlier." }
    ]
  },
  { id: 67, name: "Model Performance Monitoring Dashboard", dept: "IT / Innovation", type: "AI Capability", status: "Discovery", owner: "Innovation Lead", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Compliance & Audit", "Data Pipeline"], scores: { impact: 8, effort: 4, risk: 3, alignment: 9 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Monitoring", riskTier: "Medium", cluster: "Innovation Infrastructure", tools: ["Python", "Claude Code"], summary: "Monitoring for deployed AI tools: accuracy, correction rate, override rate, latency, failures, adoption. Without monitoring, deployed tools silently decay.",
    inputs: [
      { type: "architecture", source: "Innovation Lead Architecture Note", date: "Apr 9", text: "Common dimensions: output accuracy, correction rate, human override, latency, failure rate, data freshness, adoption. Make degradation visible before trust is lost." },
      { type: "output_sample", source: "Example Monitoring", date: "Apr 10", text: "AP Engine correction rate 8%â†’18% after new vendor format. USDA Doc Gen stayed <0.5%. Brand Asset revision rate dropped after template updates. These signals show where to invest." }
    ]
  },
  { id: 68, name: "AI Usage Governance Tracker", dept: "IT / Innovation / Security", type: "Compliance & Audit", status: "Discovery", owner: "IT Director + IT Security", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Reporting & Analytics", "Workflow Automation"], scores: { impact: 9, effort: 5, risk: 4, alignment: 10 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Approval Workflow", riskTier: "Medium", cluster: "Innovation Infrastructure", tools: ["TBD"], summary: "Lightweight governance: who builds what, which tools, what data, what's deployed. Auto-populate from Initiative Registry. Don't make it a 12-page form.",
    inputs: [
      { type: "concept", source: "IT Director Leadership Note", date: "Apr 9", text: "Broad adoption but visibility lagging. Leadership wants: who builds what, tools used, sensitive data, external APIs, deployment status. Need basic governance without bureaucracy." },
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 10", text: "Required: initiative name, owner, dept, tool/model, data classification, external API, deployment status, business process, review status. Auto-populate from registry. If too heavy, people avoid it." }
    ]
  },
  { id: 69, name: "Supplier Risk Monitor", dept: "Procurement / Supply Chain", type: "AI Capability", status: "Discovery", owner: "Procurement Director", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Reporting & Analytics", "Compliance & Audit"], scores: { impact: 7, effort: 3, risk: 5, alignment: 7 }, aiLevel: "Experiment", sensitivity: "Internal", blocker: "Data Access", pattern: "Monitoring", riskTier: "Medium", cluster: "Logistics & Supply Chain", tools: ["TBD"], summary: "Supplier risk briefs from internal + external signals. Risk: overreacting to noisy news. First version: risk briefs for review, not automatic changes.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 8", text: "Good for external + internal synthesis. Risk: overreacting to noise. First version: risk briefs for review. Connect to Ingredient Sourcing and Carrier Scorecard later." }
    ]
  },
  { id: 70, name: "Purchase Order Intake Assistant", dept: "Procurement", type: "Process Automation", status: "In Progress", owner: "Rachel Kim", targetSaaS: null, rationalization: null, capabilities: ["Workflow Automation", "Document Generation", "User-Facing App"], scores: { impact: 6, effort: 7, risk: 2, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "HITL Routing", riskTier: "Low", cluster: "Finance Automation", tools: ["Claude", "VS Code"], summary: "Converts messy email requests into structured PO drafts. Catches missing fields, asks follow-ups. Reduced incomplete PO requests. Needs category routing logic.",
    inputs: [
      { type: "telegram", source: "Rachel Â· #procurement", date: "Apr 9", text: "PO intake converts email requests into structured drafts: requester, dept, vendor, item, quantity, date, cost center, approval route. Catches missing fields." },
  ...
  { id: 72, name: "Customer Complaint Triage Assistant", dept: "QA / Sales", type: "Process Automation", status: "Discovery", owner: "Tom Nguyen + Sales Ops", targetSaaS: null, rationalization: null, capabilities: ["Workflow Automation", "Compliance & Audit", "Reporting & Analytics"], scores: { impact: 8, effort: 5, risk: 5, alignment: 8 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Exception Triage", riskTier: "High", cluster: "Compliance & Safety", tools: ["TBD"], summary: "Structured complaint intake with severity triage. Routes urgent issues immediately. Generates follow-up questions for reps. Creates QA case summary.",
    inputs: [
      { type: "process_doc", source: "QA Process Note", date: "Apr 8", text: "Complaints arrive through Sales, customer service, email, calls. Severity triage inconsistent. Foreign material â‰  labeling issue. QA wants structured routing." },
  ...
  { id: 75, name: "Animal Health Observation Logger", dept: "Live Operations", type: "Net-New Tool", status: "Discovery", owner: "Live Ops Field Supervisor", targetSaaS: null, rationalization: null, capabilities: ["User-Facing App", "Data Pipeline", "Reporting & Analytics"], scores: { impact: 7, effort: 4, risk: 5, alignment: 8 }, aiLevel: "Assist", sensitivity: "Internal", blocker: "Technical Feasibility", pattern: "Dashboard", riskTier: "Medium", cluster: "Plant Operations", tools: ["TBD"], summary: "Mobile logger for farm observations: health, water/feed, mortality, medication, environment. Must work offline with poor connectivity. AI is secondary to structured capture.",
    inputs: [
      ...
      { type: "risk", source: "Innovation Lead Assessment", date: "Apr 8", text: "Offline mode, simple input, rugged devices more important than AI. First MVP: structured capture + trend dashboard. Anomaly detection later." }
    ]
  },
  ...
  { id: 77, name: "Farm Visit Report Generator", dept: "Live Operations", type: "Process Automation", status: "Pilot", owner: "Live Ops Field Supervisor", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "User-Facing App", "Workflow Automation"], scores: { impact: 5, effort: 8, risk: 3, alignment: 6 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Document Extraction", riskTier: "Low", cluster: "Plant Operations", tools: ["Claude", "Tablet UI"], summary: "Field observations by section â†’ clean report. Needs severity labels, follow-up owners, comparison to previous visit. Short structured prompts for phone input.",
    inputs: [
      ...
      { type: "process_doc", source: "Live Ops Manager", date: "Apr 10", text: "Add severity labels and follow-up owners. Show comparison to previous visit. Don't make field reps type long notes on phone â€” use short structured prompts." }
    ]
  },
  ...
  { id: 81, name: "Production Plan Constraint Checker", dept: "Operations / Supply Chain", type: "Process Automation", status: "In Progress", owner: "Production Planner", targetSaaS: null, rationalization: null, capabilities: ["Scheduling & Planning", "Data Pipeline", "Compliance & Audit"], scores: { impact: 8, effort: 5, risk: 5, alignment: 8 }, aiLevel: "Augment", sensitivity: "Internal", blocker: null, pattern: "Exception Triage", riskTier: "Medium", cluster: "Plant Operations", tools: ["Claude Code", "Python"], summary: "Reads draft production plan and flags: packaging shortage, label mismatch, changeover conflict, labor gaps, QA holds, ship date conflicts. Caught 2 packaging issues pre-finalization.",
    inputs: [
      ...
      { type: "feedback", source: "Operations Manager", date: "Apr 11", text: "Valuable â€” catches problems before execution. Don't overload with warnings. Severity: hard stop, review needed, informational. Missing export label = hard stop." }
    ]
  },
  { id: 82, name: "Maintenance Parts Inventory Assistant", dept: "Maintenance / Procurement", type: "SaaS Replacement", status: "Discovery", owner: "Maintenance Manager", targetSaaS: "UpKeep Parts ($partial)", rationalization: "Replace", capabilities: ["Data Pipeline", "Reporting & Analytics", "Workflow Automation"], scores: { impact: 7, effort: 4, risk: 4, alignment: 7 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Dashboard", riskTier: "Low", cluster: "Plant Operations", tools: ["TBD"], summary: "Critical spare parts tracked inconsistently. First priority: part normalization and duplicate detection. Reorder recommendations after inventory master is trusted.",
    inputs: [
      ...
      { type: "feedback", source: "Procurement", date: "Apr 9", text: "Vendor part numbers are messy â€” same bearing under different descriptions. First: normalization and duplicate detection. Reorder recommendations later." }
    ]
  },
  ...
  { id: 84, name: "Software License Usage Monitor", dept: "IT / Finance", type: "Reporting & Analytics", status: "In Progress", owner: "IT Director + Finance analyst", targetSaaS: null, rationalization: null, capabilities: ["Reporting & Analytics", "Data Pipeline", "Compliance & Audit"], scores: { impact: 8, effort: 6, risk: 2, alignment: 10 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Dashboard", riskTier: "Low", cluster: "Innovation Infrastructure", tools: ["Claude", "CSV tools"], summary: "Pulls license counts, active users, login frequency, renewal dates. Found inactive-user seats and departments with concentrated power users. Show addressable savings by renewal window.",
    inputs: [
      { type: "telegram", source: "IT Director Update", date: "Apr 10", text: "Monitor pulls licenses, active users, login frequency, dept ownership, renewal, cost. Found inactive seats and departments where 2 power users and everyone else logs in quarterly." },
      { type: "process_doc", source: "Finance Note", date: "Apr 11", text: "Don't assume every inactive seat can cancel immediately â€” some annual. Show addressable savings by renewal window: immediate, 90 days, next renewal cycle." }
    ]
  },
  { id: 85, name: "Secure Prompt Review Workflow", dept: "IT Security / Innovation", type: "Compliance & Audit", status: "Discovery", owner: "IT Security Analyst", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Workflow Automation", "Document Generation"], scores: { impact: 6, effort: 7, risk: 3, alignment: 8 }, aiLevel: "Assist", sensitivity: "Confidential", blocker: null, pattern: "Approval Workflow", riskTier: "Medium", cluster: "Innovation Infrastructure", tools: ["TBD"], summary: "Flag data classification issues in shared prompts: secrets, customer names, employee data, credentials. Suggest redactions and create clean version. Fast approval for non-sensitive.",
    inputs: [
      ...
      { type: "telegram", source: "Innovation Lead Response", date: "Apr 10", text: "Make it practical. Flag data classification issues, secrets, customer/employee data, credentials. Suggest redactions. Don't make builders wait 2 days unless sensitive." }
    ]
  },
  { id: 86, name: "GitHub Prototype Inventory", dept: "IT / Innovation", type: "Reporting & Analytics", status: "Discovery", owner: "Innovation Engineer", targetSaaS: null, rationalization: null, capabilities: ["Data Pipeline", "Compliance & Audit", "Reporting & Analytics"], scores: { impact: 7, effort: 6, risk: 3, alignment: 9 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Monitoring", riskTier: "Low", cluster: "Innovation Infrastructure", tools: ["Python", "GitHub API"], summary: "Scans org repos for owner, purpose, last commit, dependencies, deployment status, README quality. Prevents orphaned tools. Adds 'production dependency' and 'business process' fields.",
    inputs: [
      ...
      { type: "feedback", source: "IT Director", date: "Apr 10", text: "Prevents orphaned tools. If someone leaves, need to know what they built and who owns it. Add 'production dependency?' and 'business process impacted?'" }
    ]
  },
  { id: 87, name: "Prototype Deployment Checklist", dept: "IT / Innovation", type: "Compliance & Audit", status: "In Progress", owner: "IT Director", targetSaaS: null, rationalization: null, capabilities: ["Compliance & Audit", "Workflow Automation", "Document Generation"], scores: { impact: 8, effort: 8, risk: 2, alignment: 9 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Approval Workflow", riskTier: "Medium", cluster: "Innovation Infrastructure", tools: ["Claude", "VS Code"], summary: "Pre-pilot checklist: owner, data classification, user group, auth, rollback plan, logging, monitoring, limitations. Needs risk tiers so low-risk tools move fast.",
    inputs: [
      { type: "concept", source: "IT Director Checklist Draft", date: "Apr 10", text: "Before pilot: owner, support contact, data classification, users, auth, access controls, rollback, logging, monitoring, known limitations, training, business approval. Not enterprise bureaucracy." },
      { type: "feedback", source: "Builder", date: "Apr 11", text: "Checklist fair but make it contextual. Marketing content generator â‰  benefits portal. Add risk tiers so low-risk moves quickly. Otherwise people avoid the process." }
    ]
  },
  { id: 88, name: "Meeting Action Item Extractor", dept: "Cross-Functional", type: "Process Automation", status: "Deployed", owner: "James Whitfield", targetSaaS: null, rationalization: null, capabilities: ["Document Generation", "Workflow Automation"], scores: { impact: 5, effort: 9, risk: 1, alignment: 5 }, aiLevel: "Assist", sensitivity: "Internal", blocker: null, pattern: "Document Extraction", riskTier: "Low", cluster: "Innovation Infrastructure", tools: ["Claude"], summary: "Used in 63 meetings. Extracts decisions, action items, owners, due dates, unresolved questions. Good adoption tool â€” low risk, helps beginners experience AI value.",
    inputs: [
      ...
      { type: "telegram", source: "Innovation Lead Note", date: "Apr 11", text: "Not strategic AI product but good adoption tool. Low risk, high usability. Helps beginners experience value. Add integration to Initiative Registry for automatic status updates." }
    ]
  },
];

export { SEED };
export const INITIAL_INITIATIVES = SEED;
